...
import { DollarSign, Scale, Globe, Wrench, Shield, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-16 max-w-3xl mx-auto">
          <div className="inline-flex items-center bg-primary/10 dark:bg-primary/20 rounded-full mb-4 px-4 py-1.5">
            <span className="text-sm font-medium text-primary">Compare & Choose</span>
          </div>
          <motion.h2 
          ...
          >
            Why Choose SmartPC Over <span className="gradient-text">Traditional Computers</span>?
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            Traditional computers come with their share of challenges: high upfront costs, limited scalability, 
            and ongoing maintenance. SenseMinder SmartPC offers a refreshing alternative. With a pay-as-you-go model, 
            instant scaling, and robust cloud security, it's designed for the modern user.
          </motion.p>
        </div>
        ...
        >
          <div className="glass-card overflow-hidden rounded-xl dark:bg-gray-900/40">
            {/* Table Header */}
            <div className="grid grid-cols-[auto_1fr_1fr] gap-4 p-6 bg-primary/5 dark:bg-primary/10 border-b border-primary/10 dark:border-primary/20">
              ...
              <div className="font-semibold text-center text-primary">SenseMinder SmartPC</div>
            </div>
              ...
              {comparisons.map((item, index) => (
                <motion.div
                  ...
                  className={`grid grid-cols-[auto_1fr_1fr] gap-4 p-6 items-center group ${
                    item.highlight ? 'bg-primary/5 dark:bg-primary/15' : ''
                  }`}
                >
        ...
        >
          <h3 className="text-2xl md:text-3xl font-bold mb-8">
            Experience the <span className="gradient-text">Freedom</span> of Cloud Computing Today!
          </h3>
          <Button
            asChild
            size="lg"
