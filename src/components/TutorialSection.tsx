...
const tutorials = [
  {
    ...
    duration: '3:45',
    description: 'Learn the basics of setting up your cloud PC environment',
...
const TutorialSection = () => {
  ...
  return (
    <section id="tutorials" className="py-20 bg-background/50 backdrop-blur-sm">
      <div className="container relative space-y-6 py-8 md:py-12 lg:py-24 lg:space-y-10">
        <div className="text-center mb-12">
          <div className="inline-flex items-center bg-primary/10 rounded-full mb-4 px-4 py-1.5">
          ...
          >
            Watch our tutorial series to master your cloud PC experience
          </motion.p>
        </div>
            ...
            >
              <div className="relative aspect-video overflow-hidden rounded-xl bg-gray-900">
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="rounded-full bg-primary/10 p-4 backdrop-blur-sm transition-transform group-hover:scale-110">
