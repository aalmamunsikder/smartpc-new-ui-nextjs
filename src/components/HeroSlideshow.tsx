...
const slides = [
  {
    ...
    darkGradient: "from-blue-500/30 to-purple-500/30"
  },
  {
    id: 2,
    ...
    darkGradient: "from-green-500/30 to-blue-500/30"
  },
  {
    id: 3,
    ...
    darkGradient: "from-purple-500/30 to-pink-500/30"
  },
  {
    id: 4,
    ...
    darkGradient: "from-orange-500/30 to-red-500/30"
  }
];
  ...
  return (
    <div className="relative w-full h-[200px] sm:h-[250px] md:h-[350px] lg:h-[400px] xl:h-[450px] overflow-hidden bg-black/10 dark:bg-black/30">
      ...
      <AnimatePresence mode="wait">
        ...
        >
          {/* Gradient Background */}
          <div className={`absolute inset-0 bg-gradient-to-br ${slides[currentSlide].gradient} dark:${slides[currentSlide].darkGradient} pointer-events-none z-[1]`} />
      ...
      <div className="absolute inset-0 flex items-center justify-between p-4 z-[5] pointer-events-none">
        <Button
          variant="ghost"
          size="icon"
          className="h-10 w-10 rounded-full bg-background/20 hover:bg-background/40 dark:bg-gray-800/50 dark:hover:bg-gray-800/70 backdrop-blur-sm pointer-events-auto"
          onClick={prevSlide}
        >
        ...
        {slides.map((_, index) => (
          <button
            ...
            className={`h-2 rounded-full transition-all ${
              index === currentSlide ? 'w-8 bg-primary' : 'w-2 bg-primary/50 dark:bg-primary/70'
            }`}
            onClick={() => {
