...
const features = [
  {
    ...
    description: 'Work from your smart monitor, tablet, or phone—no physical PC required.'
  },
  {
    icon: <Cpu className="h-10 w-10 text-primary" />,
    title: 'Customizable Configurations',
    description: 'Build your ideal setup with CPU, GPU, RAM, and Storage options.'
  },
  {
    icon: <DollarSign className="h-10 w-10 text-primary" />,
    title: 'Cost-Effective and Scalable',
    description: 'Pay only for the resources you need—scale up or down anytime.'
  },
  {
    icon: <Shield className="h-10 w-10 text-primary" />,
    title: 'Security Built-in',
    description: 'End-to-end encryption, MFA, and EBS snapshots for backups ensure peace of mind.'
  },
  {
    icon: <Users className="h-10 w-10 text-primary" />,
    title: 'Perfect for Everyone',
    description: 'Gamers, developers, designers, and businesses—customize as you go.'
  },
  {
    icon: <Gauge className="h-10 w-10 text-primary" />,
    title: 'High Performance',
    description: 'Enterprise-grade hardware with 99.9% uptime and ultra-low latency connections.'
  }
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div 
              ...
              className="glass-card p-8 relative overflow-hidden group hover-scale dark:bg-gray-900/40"
            >
              ...
              <div className="mb-4 relative">
                {feature.icon}
                <div className="absolute inset-0 blur-2xl bg-primary/10 dark:bg-primary/20 -z-10 group-hover:bg-primary/20 dark:group-hover:bg-primary/30 transition-colors duration-300" />
              </div>
              ...
              <div className="absolute inset-0 rounded-lg border border-border/5 dark:border-white/5 group-hover:border-primary/20 dark:group-hover:border-primary/30 transition-colors duration-300" />
            </motion.div>
          ))}
        </div>
      </div>
