...
import { DollarSign, TrendingDown, TrendingUp, Clock, CalendarDays, CreditCard } from 'lucide-react';
...
const savingsRecommendations = [
  {
    ...
    description: 'Automatically shut down your PC during non-working hours to save up to 40%.',
  ...
  },
  {
    ...
    description: 'Commit to a longer-term usage plan for significant discounts.',
...
const CostAnalysis = () => {
  ...
  const previousMonthTotal = monthlyUsageData[(new Date().getMonth() + 11) % 12].cost;
  ...
  const dailyAverage = dailyUsageData.reduce((acc, day) => acc + day.cost, 0) / 7;
  ...
  return (
    <Card className="w-full">
      <CardHeader>
        ...
        <CardDescription>Monitor usage costs and find ways to optimize spending</CardDescription>
      </CardHeader>
      <CardContent>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                ...
                <div className={`flex items-center px-2 py-1 rounded-full text-xs ${
                  parseFloat(percentChange) > 0 ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600'
                }`}>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-baseline gap-1 mt-1">
                    <DollarSign className="h-4 w-4 text-muted-foreground" />
                    <span className="text-2xl font-bold">{projectedMonthly}</span>
                  </div>
                </div>
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <div className="flex items-baseline gap-1 mt-1">
                    <DollarSign className="h-4 w-4 text-muted-foreground" />
                    <span className="text-2xl font-bold">{dailyAverage.toFixed(2)}</span>
                  </div>
                </div>
        ...
        <Tabs defaultValue="breakdown" className="w-full">
              ...
              <div className="space-y-4">
                ...
                {costData.map((item) => (
                  <div key={item.name} className="flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-2">
                      <span className="font-medium">${((item.value / 100) * currentMonthTotal).toFixed(2)}</span>
          ...
          <TabsContent value="history">
            ...
            <div className="h-[300px]">
              ...
              >
                <BarChart
                  data={timeRange === 'week' ? dailyUsageData : monthlyUsageData}
          ...
          <TabsContent value="optimization">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <h3 className="text-sm font-medium">Cost Saving Recommendations</h3>
              ...
              {savingsRecommendations.map((recommendation) => (
                <Card key={recommendation.id} className={`${
                  recommendation.implemented ? 'bg-green-50 border-green-200' : 'bg-card'
                }`}>
                  <CardContent className="p-4">
                    <div className="flex items-start justify-between">
                      ...
                      <div className="flex flex-col items-end">
                        ...
                        <span className="text-lg font-bold text-green-600">{recommendation.savingsPercentage}%</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
