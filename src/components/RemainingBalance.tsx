      ...
      <AlertDialog open={showLowBalanceAlert} onOpenChange={setShowLowBalanceAlert}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Your balance is running low (${balance.toFixed(2)}). To ensure uninterrupted service,
              please recharge your account soon. Your SmartPCs may be suspended if the balance
              reaches $0.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
