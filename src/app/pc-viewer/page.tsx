...
const PCViewerContent = () => {
  ...
  const [dcvConfig, setDcvConfig] = useState({
    quality: 'high',
    keyboard: true,
    mouse: true,
    touch: true,
  ...
  }, [searchParams, setConnectionState, setTvEffect, setDcvSession, setIsConnected, setDcvError]);
  ...
  return (
    <div className="flex min-h-screen bg-white dark:bg-gray-950">
      ...
      <div id="remote-desktop" className="flex-1 bg-gradient-to-br from-gray-900 to-black relative overflow-hidden">
        {/* TV On/Off Animation */}
        <AnimatePresence>
          {tvEffect === 'on' && (
            <>
              <motion.div
                ...
                style={{
                  backgroundImage: 'linear-gradient(0deg, transparent 0%, rgba(255, 255, 255, 0.1) 2%, transparent 3%)',
          ...
          {tvEffect === 'off' && (
            <>
              <motion.div
                ...
                style={{
                  backgroundImage: 'linear-gradient(0deg, transparent 0%, rgba(255, 255, 255, 0.05) 2%, transparent 3%)',
                  backgroundSize: '100% 3px',
                }}
              />
              <motion.div
        ...
        >
          <div className="w-32 h-32 text-white/10">
            <svg viewBox="0 0 88 88" xmlns="http://www.w3.org/2000/svg">
              <path fill="currentColor" d="M0 12.402l35.687-4.86.016 34.423-35.67.203zm35.67 33.529l.028 34.453L.028 75.48.026 45.7zm4.326-39.025L87.314 0v41.527l-47.318.376zm47.329 39.349l-.011 41.34-47.318-6.677-.066-34.739z"/>
            </svg>
        </div>
        </motion.div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <Badge 
                  ...
                  className={cn(
                    "font-medium",
                    connectionState === 'CONNECTED' && "bg-green-500/10 text-green-500",
                    connectionState === 'DISCONNECTED' && "bg-red-500/10 text-red-500",
                    connectionState === 'RECONNECTING' && "bg-yellow-500/10 text-yellow-500"
                  )}
                >
                  {connectionState}
                </Badge>
