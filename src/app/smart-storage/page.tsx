...
import { Check, Shield, Share2, Clock, Cloud, Server } from 'lucide-react';
      ...
      <div className="min-h-screen pt-20 pb-16">
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="text-center mb-16">
            ...
            >
              Secure, reliable, and fast cloud storage for all your needs. Access your files anywhere, anytime.
            </motion.p>
          </div>
              ...
              <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-2xl font-bold">{formatStorageSize(storageSize)}</span>
                  </div>
                  <Slider
                    value={[storageSize]}
