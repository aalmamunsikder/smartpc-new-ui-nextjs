    ...
    <main className="flex-grow pt-24 pb-16">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="max-w-4xl mx-auto">
          <h1 className="text-4xl md:text-5xl font-bold mb-6 gradient-text">Cookie Policy</h1>
          <p className="text-gray-400 mb-8">Last Updated: {lastUpdated}</p>
          
          <div className="glass-card p-8 rounded-xl space-y-6">
            <p className="text-gray-300">
              This Cookie Policy explains how SmartPC ("we", "us", or "our") uses cookies and similar technologies to recognize you when you visit our website and use our services. It explains what these technologies are and why we use them, as well as your rights to control our use of them.
            </p>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="text-lg font-medium text-primary">Essential Cookies</h4>
                  <p className="text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-medium text-primary">Performance and Functionality Cookies</h4>
                  <p className="text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-medium text-primary">Analytics and Customization Cookies</h4>
                  <p className="text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-medium text-primary">Advertising Cookies</h4>
                  <p className="text-gray-300">
                ...
                <div>
                  <h4 className="text-lg font-medium text-primary">Social Media Cookies</h4>
                  <p className="text-gray-300">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                Here is a list of the cookies that we use. We've listed them here so you can choose if you want to opt-out of cookies or not.
              </p>
                ...
                <table className="w-full text-sm text-left">
                  ...
                  <tbody>
                    ...
                    <tr className="border-b border-white/10">
                      ...
                      <td className="px-6 py-4">Used to throttle request rate.</td>
                      <td className="px-6 py-4">1 minute</td>
                      <td className="px-6 py-4">Analytics</td>
                    </tr>
                    <tr className="border-b border-white/10">
                      <td className="px-6 py-4">session_id</td>
                      <td className="px-6 py-4">Used to maintain session state.</td>
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300">
                If you have any questions about our use of cookies or other technologies, please email us at <a href="mailto:privacy@smartpc.com" className="text-primary hover:underline">privacy@smartpc.com</a>.
              </p>
            </div>
          </div>
        </div>
