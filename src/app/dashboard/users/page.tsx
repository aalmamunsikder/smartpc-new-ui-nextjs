...
const UsersManagementPage = () => {
  ...
  const getAssignedPCs = (pcIds: number[]) => {
    return pcIds.map(id => mockSmartPCs.find(pc => pc.id === id)?.name).filter(Boolean);
  };
    ...
    <div className="space-y-6">
        ...
        <CardHeader className="pb-3">
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>Invite, organize, and manage user access</CardDescription>
            </div>
                      ...
                      <TableRow key={user.id}>
                        ...
                        <TableCell>
                          <div className="flex flex-wrap gap-1">
                            {getAssignedPCs(user.assignedPCs).map((pcName, index) => (
                        ...
                        <TableCell>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align="end">
                              <DropdownMenuItem onClick={() => handleAssignPC(user.id)}>
      ...
      <Dialog open={isInviteDialogOpen} onOpenChange={setIsInviteDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          ...
          <Form {...userForm}>
            <form onSubmit={userForm.handleSubmit(handleInviteUser)} className="space-y-4">
              <FormField
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Software engineering department" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
      ...
      {/* Assign PC Dialog */}
      <Dialog open={isAssignPCDialogOpen} onOpenChange={setIsAssignPCDialogOpen}>
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
