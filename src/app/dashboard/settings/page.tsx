        ...
        <TabsContent value="general" className="space-y-6 mt-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Manage general account preferences</CardDescription>
            </CardHeader>
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Your cloud PC will hibernate after this period of inactivity
                </p>
              </div>
        ...
        <TabsContent value="security" className="space-y-6 mt-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="trusted-devices">Remember Trusted Devices</Label>
                  <p className="text-sm text-muted-foreground">
        ...
        <TabsContent value="advanced" className="space-y-6 mt-6">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label htmlFor="cloud-backup">Automatic Cloud Backup</Label>
                  <p className="text-sm text-muted-foreground">
          ...
          <Card className="border-destructive/50">
            ...
            <CardContent className="space-y-4">
              <div className="border border-destructive/20 rounded-lg p-4">
                <h3 className="font-medium mb-1">Reset Cloud PC</h3>
                <p className="text-sm text-muted-foreground mb-4">
                  This will reset your Cloud PC to its default state. All installed applications
                  and configurations will be lost.
                </p>
