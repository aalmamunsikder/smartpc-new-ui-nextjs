...
import { HardDrive, Cpu, MemoryStick, Upload, Download, Clock } from 'lucide-react';
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  <span className="text-2xl font-bold">
                    {resource.usage.used}{resource.unit}
                  </span>
                </div>
                <span className="text-muted-foreground text-sm">
                  of {resource.usage.total}{resource.unit}
                </span>
              </div>
              <Progress value={resource.usage.percentage} className="h-2 mt-2" />
            </CardContent>
          </Card>
        ))}
      </div>
      ...
      <div className="grid grid-cols-1 gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Manage your cloud PC resources</CardDescription>
          </CardHeader>
          <CardContent>
