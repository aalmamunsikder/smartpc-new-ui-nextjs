    ...
    <div className="space-y-6">
      <div className="space-y-2 text-center">
        ...
        <p className="text-sm text-gray-500 dark:text-gray-400">
          Enter your details to create your cloud PC account
        </p>
      </div>

      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="space-y-2">
          <label className="text-sm font-medium text-gray-700 dark:text-gray-200" htmlFor="full-name">
            Full Name
          </label>
          <Input
            id="full-name"
      ...
      <div className="grid grid-cols-2 gap-4">
        <Button variant="outline" className="w-full border-gray-200 bg-white/50 text-gray-700 hover:bg-gray-50 dark:border-[#ffffff1a] dark:bg-[#ffffff0f] dark:text-white dark:hover:bg-[#ffffff1a]">
